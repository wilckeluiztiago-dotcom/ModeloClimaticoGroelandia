...
class SuiteTestesBase(ABC):
    """Classe base abstrata para SuiteTestes."""
    @abstractmethod
    def inicializar(self): pass
    @abstractmethod
    def executar(self, *args, **kwargs): pass

class SuiteTestes(SuiteTestesBase):
    """
    Implementação de SuiteTestes com lógica de alta fidelidade.
    ...
    def executar_todos(self):
        """Implementação específica: executar_todos"""
        self._status = "COMPUTING_EXECUTAR_TODOS"
        try:
            # Validação
